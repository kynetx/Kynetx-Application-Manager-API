...
allow Kynetx developers a way to create, update , delete Kynetx KRLrule sets.  This api also provides access to
many other services like the Kynetx Browser Extention factory.
...
* View Source on GitHub (http://github.com/ciddennis/Kynetx-Application-Manager-API)
* Report Issues on GitHub (http://github.com/ciddennis/Kynetx-Application-Manager-API/issues)
* Read More at the Wiki (http://wiki.github.com/ciddennis/Kynetx-Application-Manager-API/)
...
1. First you must provide a way for the Oauth do this by providing two action in a controller.
...
2.  Once you have authorized the application you can start doing things with the api.  Here are some examples
 ...
 Active Record "Like" usages:
        ...
        user.applications()
        application = user.create_application("my app nanme","This is the description");
        # Save ruleset back.
