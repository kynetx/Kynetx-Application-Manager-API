...
Gem::Specification.new do |s|
  s.name = %q{kynetx-application-manager-api}
  s.version = "0.1.0"
  ...
  s.has_rdoc = true
  s.summary = %q{Simple Gem used to communicate with the Kynetx Application Manager API.}

  s.description = <<-EOF
    Using this gem you can access the Kynetx Application Manager API.  This api allows developers a way
